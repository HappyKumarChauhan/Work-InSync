      ...
      <View style={styles.main}>
          ...
          {idTypes.map((id, index) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor:
                    selectedIdType === id ? 'green' : colors.secondaryBg,
        ...
        <View
          ...
          <View style={styles.uploadTextContainer}>
            <Text style={[styles.cardTitle, {color: colors.color}]}>
              Upload Proof Identity
            </Text>
            <Text
              style={[styles.cardDescription, {color: colors.secondaryColor}]}>
              We accept only ID card, Driving License, or Passport
            </Text>
          </View>
          <TouchableOpacity
            style={[styles.uploadButton, {borderColor: colors.color}]}
            onPress={() => {
